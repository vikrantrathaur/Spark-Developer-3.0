...
display(dbutils.fs.ls('/mnt/training/ecommerce'))
...
# MAGIC -- # TODO
# MAGIC 
# MAGIC Create table if not exists users as select * from parquet.`/mnt/training/ecommerce/users/users.parquet`;
# MAGIC Create table if not exists sales as select * from parquet.`/mnt/training/ecommerce/sales/sales.parquet`;
# MAGIC Create table if not exists products as select * from parquet.`/mnt/training/ecommerce/products/products.parquet`;
# MAGIC 
